...
class App(ctk.CTk):
    ...
    def make_widgets(self):
        ...
        create_button = ctk.CTkButton(master=self, text="Create", font=("System", 20, "normal"), width=160,
                                      border_width=0, height=45,
                                      command=lambda func_name="create_password": self.events(func_name))
        create_button.place(relx=0.55, rely=0.51)
        self.widgets["create_button"] = create_button

        search_button = ctk.CTkButton(master=self, text="Search", font=("System", 20, "normal"), width=160,
                                      border_width=0,
        ...
        qr_scan_button = ctk.CTkButton(master=self, text="QR Scan", font=("System", 20, "normal"), width=160,
                                       border_width=0, height=45,
                                       command=lambda func_name="qr_scan": self.events(func_name))
        ...
        username_entry = ctk.CTkEntry(master=self, width=700, height=70, border_width=2, corner_radius=0,
                                      placeholder_text="Username:", font=("System", 22, "normal"), justify="center",
                                      fg_color="#393E46")
        ...
        hidden_err_label = ctk.CTkLabel(master=hidden_err_frame, corner_radius=0, font=("System", 25, "normal"),
                                        text="", fg_color="#212121")
